...
-- ============================================================================
-- Application compagnon « Suivi des règlements » (route /suivi)
-- ----------------------------------------------------------------------------
-- Tables préfixées sr_, indépendantes du back-office, reliées à lui par des
-- colonnes de liaison nullables. Contenu identique à
-- supabase/migrations/014_suivi_reglements.sql, repris ici pour qu'une base
-- neuve soit complète en une seule exécution. Voir docs/suivi-reglements.md.
-- ============================================================================
